        ...
        {product.name
            ? <div className="description">
                <div style={{ textAlign: "right" }}>
                    {userId === product.author._id && <button style={{ justifySelf: "flex-left" }} onClick={del}><Trash /></button>}
                </div>
                <div className="part1">
                    <div className="part2"> <h1>{product.name}</h1></div>
                    <div className="part3"> {product.likes.length === 1 ? <HeartFill /> : <Heart />}</div>
                </div>
                ...
                <div className="areas">
                    ...
                    <div className="area__price">
                        ...
                        <div className="promo1">
                            <div className="pic"><CarFront /></div>
                        ...
                        <div className="promo1">
                            <div className="pic"><Award /></div>
                            <div className="promo__text">
                                <b>Гарантия качества</b>
                                <p>Если вам не понравилось качество нашей продукции, мы вернем деньги, либо сделаем все возмонжое, чтобы довлетворить ваши нужды</p>
                            </div>
                        </div>
                    </div>
                </div>
